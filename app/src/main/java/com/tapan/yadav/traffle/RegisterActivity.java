...
public class RegisterActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //regEmail = findViewById(R.id.inputLayoutEmail);
        regEmailText = findViewById(R.id.reg_email);
       // regPassword = findViewById(R.id.inputLayoutPassword);
        regPasswordText = findViewById(R.id.reg_password);
       // regConfirmPassword = findViewById(R.id.inputLayoutConfirmPassword);
        ...
        reg_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String confirm_pass = regConfirmPasswordText.getText().toString();
                        ...
                        mAuth.createUserWithEmailAndPassword(email, pass).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                            ...
                            public void onComplete(@NonNull Task<AuthResult> task) {
                                ...
                                if(task.isSuccessful()){
                                    ...
                                    Intent setupIntent = new Intent(RegisterActivity.this, ProfileSetup.class);
